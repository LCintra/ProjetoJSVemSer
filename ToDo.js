/*
        ...
        2) Tela de cadastro de usuário:
            ...
            2b) Teremos os seguintes campos no cadastro:
                ...
                b) Data de Nascimento (validar se é uma data válida e se possui pelo menos 18 anos);
                c) Email (validação de formato de email);
                d) Senha (mínimo 8 caracteres, ao menos 1 letra maiúscula, ao menos 1 letra minúscula, ao menos 1 número e ao menos 1 caracter especial);
                e) Primeiro Emprego? (utilizar checkbox para ter o valor true/false) => OBS: este campo só aparece se estiver selecionado o tipo "Trabalhador" no cadastro;
